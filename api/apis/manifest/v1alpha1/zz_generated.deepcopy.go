...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageRepo) DeepCopyInto(out *ImageRepo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageRepo.
func (in *ImageRepo) DeepCopy() *ImageRepo {
	if in == nil {
		return nil
	}
	out := new(ImageRepo)
