...
type KubeanClusterConfig struct {
...
type Status struct {
	// +optional
	AirGapStatus AirGapStatus `json:"airGap,omitempty"`
}
...
type KubeanClusterConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	// Items holds a list of KubeanClusterConfig.
	Items []KubeanClusterConfig `json:"items"`
}
...
func (status *AirGapStatus) MergeSoftwareInfo(name string, versionRange []string) bool {
...
func (status *AirGapStatus) MergeDockerInfo(osName string, versionRange []string) bool {
