...
import (
	...
	"kubean.io/api/generated/kubeanclusterconfig/clientset/versioned/scheme"
)

type KubeanV1alpha1Interface interface {
	RESTClient() rest.Interface
	KubeanClusterConfigsGetter
}
...
func (c *KubeanV1alpha1Client) KubeanClusterConfigs() KubeanClusterConfigInterface {
	return newKubeanClusterConfigs(c)
}
