...
type KuBeanOfflineVersionInterface interface {
	...
	UpdateStatus(ctx context.Context, kuBeanOfflineVersion *v1alpha1.KuBeanOfflineVersion, opts v1.UpdateOptions) (*v1alpha1.KuBeanOfflineVersion, error)
...
func newKuBeanOfflineVersions(c *KubeanofflineversionV1alpha1Client) *kuBeanOfflineVersions {
...
func (c *kuBeanOfflineVersions) UpdateStatus(ctx context.Context, kuBeanOfflineVersion *v1alpha1.KuBeanOfflineVersion, opts v1.UpdateOptions) (result *v1alpha1.KuBeanOfflineVersion, err error) {
	result = &v1alpha1.KuBeanOfflineVersion{}
	err = c.client.Put().
		Resource("kubeanofflineversions").
		Name(kuBeanOfflineVersion.Name).
