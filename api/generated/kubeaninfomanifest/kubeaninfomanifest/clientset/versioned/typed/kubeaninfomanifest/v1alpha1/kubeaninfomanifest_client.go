...
import (
	...
	"kubean.io/api/generated/kubeaninfomanifest/clientset/versioned/scheme"
)

type KubeanV1alpha1Interface interface {
	RESTClient() rest.Interface
	KubeanInfoManifestsGetter
}
...
func (c *KubeanV1alpha1Client) KubeanInfoManifests() KubeanInfoManifestInterface {
	return newKubeanInfoManifests(c)
}
